describe("Timeline", () => {
  ...
  it("should update a post", () => {
    ...
    cy.get('input[placeholder="Título"]').clear().type("Novo título");
    cy.get("textarea").clear().type("Novo conteúdo");
  ...
  it("should cancel edit mode", () => {
    ...
    cy.get('input[placeholder="Título"]').should("not.exist");
  });
